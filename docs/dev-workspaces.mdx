...
# or pull the CI image (after GHCR packages are public):
# docker pull ghcr.io/toxicoder/nvidia-dgx-spark-lab/coder-workspace:development
```
...
# or pull the CI image (after GHCR packages are public) and override Helm:
