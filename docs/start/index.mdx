...
| Decide 1–5 nodes, the fabric, and which Spark orchestrates | [Choose topology](choose-topology.md) |
| Edit node IPs, the switch port map, or move the control plane | [Lab topology](lab-topology.md) |
