...
| --- | --- | --- | --- |
| **kimi-test** | `start-test` | 1–5 | First validation. `backoffLimit: 2`. Not heavy. |
...
| **Qwen 3.5** | `start-qwen3.5-122b-nvfp4`, `start-qwen3.5-397b-spark2`, `start-qwen3.5-397b-nvfp4` | 1 / 2 / **4–5** | 397B NVFP4 is four nodes (switch lab, or five). |
