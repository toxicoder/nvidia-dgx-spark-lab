...
Single-GPU NVFP4 reasoning model (30B A3B MoE) on vLLM v0.8.5.

**What's on this page**

- Production Job for Nemotron 3 Nano 30B A3B (1 GPU NVFP4) with explicit resources, OnFailure + backoff 1, high-speed NCCL
- Requirements, usage via kubectl/kustomize, safety and stop notes

**What this enables**

- Running Nemotron 3 Nano 30B A3B on a single DGX Spark GPU with proper resource isolation and interconnect config
...
```bash
kubectl apply -k k8s/workloads/nemotron-3-nano-30b/
```
