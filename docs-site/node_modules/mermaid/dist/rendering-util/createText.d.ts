 ...
 */
export declare const createText: (el: D3Selection<SVGGElement>, text?: string, { style, isTitle, classes, useHtmlLabels, markdown, isNode, width, minWidth, addSvgBackground, }?: {
