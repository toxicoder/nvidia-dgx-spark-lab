...
export declare function defaultMeasureLayout(data4Layout: LayoutData, { element }: CommonLayoutRenderContext, options?: CreateGraphOptions): Promise<CommonLayoutMeasure>;
