...
export declare function measureGroupLabel(nodesGroup: D3Selection<SVGGElement>, node: ClusterNode, measureWidth?: number): Promise<void>;
...
export declare function createGraphWithElements(element: D3Selection, data4Layout: LayoutData, options?: CreateGraphOptions): Promise<{
