...
// src/diagrams/agentflow/diagnostics.ts
...
// src/diagrams/agentflow/shapes.ts
...
// src/diagrams/agentflow/colorSlots.ts
...
function assignColorSlots(nodes, kindOf, containerOrder) {
  const palette = getConfig().themeVariables?.borderColorArray;
...
// src/diagrams/agentflow/agentflowDb.ts
...
You have to call mermaid.initialize.`
  ...
  getElementAtPosition(line, column) {
    ...
    const span = /* @__PURE__ */ __name(({ position }) => [
...
// src/diagrams/agentflow/renderer.ts
...
// src/diagrams/agentflow/parser/agentflow.jison
var parser = (function() {
...
// src/diagrams/agentflow/parser/agentflowParser.ts
...
// src/diagrams/agentflow/styles.ts
...
var getStyles = /* @__PURE__ */ __name((options) => `${genColor(options)}
  .label {
...
// src/diagrams/agentflow/diagram.ts
var diagram = {
