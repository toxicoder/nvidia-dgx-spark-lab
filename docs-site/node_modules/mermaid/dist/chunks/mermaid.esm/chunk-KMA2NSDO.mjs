...
var whitespace = /\s/;
var stripAnyComments = /* @__PURE__ */ __name((text2) => {
  let out = "";
  let consumed = 0;
  let searchFrom = 0;
...
var transparentize = /* @__PURE__ */ __name((color, amount) => {
...
var _resolveSetOption = /* @__PURE__ */ __name(function _resolveSetOption2(cfg, key, fallback, options) {
...
function createDOMPurify() {
  ...
  const _checkSvgNamespace = /* @__PURE__ */ __name(function _checkSvgNamespace2(tagName, parent, parentTagName) {
  ...
  const _checkMathMlNamespace = /* @__PURE__ */ __name(function _checkMathMlNamespace2(tagName, parent, parentTagName) {
    if (parent.namespaceURI === HTML_NAMESPACE) {
      return tagName === "math";
    }
  ...
  }, "_checkMathMlNamespace");
  const _checkHtmlNamespace = /* @__PURE__ */ __name(function _checkHtmlNamespace2(tagName, parent, parentTagName) {
  ...
  const _neutralizeRoot = /* @__PURE__ */ __name(function _neutralizeRoot2(root) {
  ...
  const _stripDisallowedAttributes = /* @__PURE__ */ __name(function _stripDisallowedAttributes2(element) {
  ...
  const _neutralizeSubtree = /* @__PURE__ */ __name(function _neutralizeSubtree2(root) {
    const stack = [root];
  ...
  const _neutralizePatchLinkage = /* @__PURE__ */ __name(function _neutralizePatchLinkage2(root) {
    if (!SAFE_FOR_XML) {
      return;
    }
    const stack = [root];
  ...
  const _stripTemplateExpressions = /* @__PURE__ */ __name(function _stripTemplateExpressions2(value) {
    value = stringReplace(value, MUSTACHE_EXPR$1, " ");
    value = stringReplace(value, ERB_EXPR$1, " ");
    value = stringReplace(value, TMPLIT_EXPR$1, " ");
    return value;
  }, "_stripTemplateExpressions");
  ...
  const _isUnsafeNode = /* @__PURE__ */ __name(function _isUnsafeNode2(currentNode, tagName) {
  ...
  const _sanitizeDisallowedNode = /* @__PURE__ */ __name(function _sanitizeDisallowedNode2(currentNode, tagName) {
  ...
  const _sanitizeElements = /* @__PURE__ */ __name(function _sanitizeElements2(currentNode, root) {
  ...
  const _applyTrustedTypesToAttribute = /* @__PURE__ */ __name(function _applyTrustedTypesToAttribute2(lcTag, lcName, namespaceURI, value) {
  ...
  const _setAttributeValue = /* @__PURE__ */ __name(function _setAttributeValue2(currentNode, name, namespaceURI, value) {
    try {
      if (namespaceURI) {
  ...
  const _sanitizeAttachedShadowRoots = /* @__PURE__ */ __name(function _sanitizeAttachedShadowRoots2(root) {
    const stack = [{
      node: root,
      shadow: null
    }];
...
var renderKatexUnsanitized = /* @__PURE__ */ __name(async (text2, config2) => {
  ...
  if (true) {
    const { default: katex } = await import("./katex-F5DCXIFN.mjs");
