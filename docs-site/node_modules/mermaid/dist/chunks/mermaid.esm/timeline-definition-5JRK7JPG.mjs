  ...
  if (look === "neo") {
    ...
    if (isReduxTheme) {
      ...
      if (rootSvg.select(`#${dropShadowId}`).empty()) {
        ...
        defsEl.append("filter").attr("id", dropShadowId).attr("height", "130%").attr("width", "130%").append("feDropShadow").attr("dx", "4").attr("dy", "4").attr("stdDeviation", 0).attr("flood-opacity", isDark ? "0.2" : "0.06").attr("flood-color", isDark ? "#FFFFFF" : "#000000");
      }
    }
  }
  return node;
