...
export function paletteColor(palette: any, index: any): any;
...
export function dropShadowId(diagramId: any): string;
export function insertDropShadow(elem: any, conf: any, diagramId: any): void;
