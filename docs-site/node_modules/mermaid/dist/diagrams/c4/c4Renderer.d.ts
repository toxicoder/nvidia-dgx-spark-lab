...
import type { C4Boundary, C4Element, C4Rel, C4Shape } from './c4Types.js';
...
export declare const drawRels: (diagram: SVG, rels: C4Rel[], getC4ShapeObj: (alias: string) => C4Element | undefined, diagObj: Diagram, diagramId: string) => void;
/**
