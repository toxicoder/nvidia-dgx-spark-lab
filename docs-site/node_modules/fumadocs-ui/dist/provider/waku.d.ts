...
export interface RootProviderProps extends ComponentProps<typeof RootProvider$1> {
  /**
...
export declare function RootProvider({ components, ...props }: RootProviderProps): import("react").JSX.Element;
//#endregion