...
export declare function getLayoutTabs(tree: PageTree.Root, { transform }?: GetLayoutTabsOptions): LayoutTab[];
export declare function isLayoutTabActive(tab: LayoutTab, pathname: string): boolean;
...
export declare function useLinkItems({ githubUrl, links }: Pick<BaseLayoutProps, 'links' | 'githubUrl'>): {
  navItems: LinkItemType[];
  menuItems: LinkItemType[];
  all: LinkItemType[];
};
export declare function isLinkItemActive(link: LinkItemType, pathname: string): boolean;
//#endregion
export { type BaseSlots, type BaseSlotsProps, LinkItem, baseSlots };