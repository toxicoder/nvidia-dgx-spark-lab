...
export declare function Tabs({ ref, groupId, persist, updateAnchor, defaultValue, value: _value, onValueChange: _onValueChange, ...props }: TabsProps): import("react").JSX.Element;
export declare function TabsContent({ value, ref, ...props }: ComponentProps<typeof Primitive.TabsContent>): import("react").JSX.Element;
//#endregion
export { tabs_d_exports };