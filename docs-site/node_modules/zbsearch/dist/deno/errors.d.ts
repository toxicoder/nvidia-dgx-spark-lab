declare const errors: {
    ...
    UNKNOWN_VECTOR_PROPERTY: string;
    ...
    PLUGIN_COMPONENT_CONFLICT: string;
    IVF_INDEX_REQUIRES_FACTORY: string;
    RESERVED_SCHEMA_PROPERTY: string;
    SUGGEST_NOT_SUPPORTED: string;
};
export type ErrorCode = keyof typeof errors;
export interface ZBSearchError extends Error {
    code: string;
}
export declare function createError(code: ErrorCode, ...args: Array<string | number>): ZBSearchError;
export {};
