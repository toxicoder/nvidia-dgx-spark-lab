...
import { findSimilarVectors } from "./vector.js";
...
function getProbeCentroids(queryVector, centroids, nprobe, dim) {
	const scores = centroids.map((centroid, index) => [index, dotProduct(queryVector, centroid, dim)]);
