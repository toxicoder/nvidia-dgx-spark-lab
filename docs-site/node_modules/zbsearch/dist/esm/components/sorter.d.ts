import { AnySorterStore, ISorter, SearchableType, SortType } from '../types.js';
...
export declare function addSortablePropertyToSorter(sorter: Sorter, path: string, type: SearchableType): void;
export declare function load<R = unknown>(sharedInternalDocumentStore: InternalDocumentIDStore, raw: R): Sorter;
export declare function loadAsync<R = unknown>(sharedInternalDocumentStore: InternalDocumentIDStore, raw: R): Promise<Sorter>;
