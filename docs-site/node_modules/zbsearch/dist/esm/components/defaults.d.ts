...
import { AnyDocument, AnySchema, AnyZBSearch, ArraySearchableType, ElapsedTime, ScalarSearchableType, TypedDocument, Vector } from '../types.js';
...
export declare function assertSchemaHasNoReservedKeys(schema: AnySchema, prefix?: string): void;
export declare function validateSchema<T extends AnyZBSearch, ResultDocument extends TypedDocument<T>>(doc: ResultDocument, schema: T['schema']): Optional<string>;
