...
const languages_js_1 = require("./components/tokenizer/languages.js");
const utils_js_1 = require("./utils.js");
const allLanguages = [...languages_js_1.SUPPORTED_LANGUAGES, languages_js_1.MULTILINGUAL_LANGUAGE].join('\n - ');
const errors = {
...
function createError(code, ...args) {
    const error = new Error((0, utils_js_1.sprintf)(errors[code] ?? `Unsupported ZBSearch Error code: ${code}`, ...args));
    error.code = code;
