...
function create(args = {}) {
    ...
    (0, defaults_js_1.assertSchemaHasNoReservedKeys)(schema);
    ...
    for (const hook of plugins_js_1.AVAILABLE_PLUGIN_HOOKS) {
        zbsearch[hook] = (zbsearch[hook] ?? []).concat((0, plugins_js_1.getAllPluginsByHook)(zbsearch, hook));
    }
    const afterCreate = zbsearch['afterCreate'];
    if (afterCreate) {
        (0, hooks_js_1.runAfterCreate)(afterCreate, zbsearch);
    }
    return zbsearch;
}
function getVersion() {
