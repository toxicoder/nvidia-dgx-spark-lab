...
exports.LANGUAGES_WITH_SIGNIFICANT_DIACRITICS = exports.SUPPORTED_LANGUAGES = exports.SPLITTERS = exports.MULTILINGUAL_LANGUAGE = exports.SUPPORTED_LANGUAGE_LOCALES = void 0;
...
exports.SUPPORTED_LANGUAGE_LOCALES = {
    arabic: 'ar',
    armenian: 'hy',
    bulgarian: 'bg',
    czech: 'cs',
...
exports.MULTILINGUAL_LANGUAGE = 'multilingual';
...
exports.SPLITTERS = Object.fromEntries(Object.entries(SPLITTER_ALPHABETS).map(([language, alphabet]) => [
    language,
    new RegExp(`[^${FOLDABLE_LETTERS}${alphabet}]+`, 'gim')
]));
exports.SUPPORTED_LANGUAGES = Object.keys(exports.SUPPORTED_LANGUAGE_LOCALES);
function getLocale(language) {
    return language !== undefined && exports.SUPPORTED_LANGUAGES.includes(language)
        ? exports.SUPPORTED_LANGUAGE_LOCALES[language]
        : undefined;
}
...
exports.LANGUAGES_WITH_SIGNIFICANT_DIACRITICS = new Set(['vietnamese']);
