...
const STARTABLE_MODELS: { id: InferenceModelName; label: string; heavy: boolean }[] = [
  ...
  { id: "qwen3.8-27b-nvfp4", label: "qwen3.8-27b", heavy: true },
  { id: "qwen3.8-flash-next-nvfp4", label: "qwen3.8-flash-next", heavy: true },
  { id: "glm-5.3-flash", label: "glm-5.3-flash", heavy: true },
  { id: "deepseek-v4.1-flash", label: "dsv4.1-flash", heavy: true },
  { id: "litellm", label: "litellm", heavy: false },
